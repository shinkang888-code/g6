    ...
    <footer className="border-t border-slate-200 bg-white">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <Link href="/www" className="flex items-center gap-2">
              ...
              <span className="font-bold text-[#0A1628]">LawBoard</span>
            </Link>
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-slate-500">
              LawBoard는 로펌·법무팀을 위한 송무관리 프로그램입니다. 사건·기일·결재·고객·엑셀 연동을 하나의 플랫폼에서 제공합니다.
            </p>
            <p className="mt-4 text-xs text-slate-400">
              LawBoard는 법률사무 처리나 법률 자문을 대행하지 않습니다. 구체적인 사안은 변호사 등 법률 전문가의 조언을 받으시기 바랍니다.
            </p>
          </div>
          <div>
            <h4 className="text-sm font-bold text-slate-900">제품</h4>
            <ul className="mt-4 space-y-2 text-sm text-slate-600">
              <li><Link href="/www#product-core" className="hover:text-slate-900">LawBoard Core</Link></li>
        ...
        <div className="mt-12 border-t border-slate-100 pt-8 text-center text-xs text-slate-400">
          © {new Date().getFullYear()} LawBoard. All rights reserved.
        </div>
      </div>
    </footer>
  );
